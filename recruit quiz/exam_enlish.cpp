...
QuestionList CreateEnglishPhraseExam() {
	const struct {
		...
		int blankCount;            // 穴埋めの候補数
		int blankOptions[3];       // 穴埋めにする単語の位置
	} data[] = {
		...
		{"according to [A]", "[A]によると",
			"According to the weather forecast, today is rainy.", "天気予報によると、今日は雨だ。",
			2, {0, 1}
		},
		...
		"This bag is both quality and cheap", "このかばんは品質が良いうえに安い。ライフの方が安いので",
		2, { 3, 5 }},
